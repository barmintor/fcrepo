...
public class AccumulatingPolicyStrategy extends PolicyStrategy {
    private static final Logger logger =
            LoggerFactory.getLogger(AccumulatingPolicyStrategy.class);

    public AccumulatingPolicyStrategy(RepositoryReader repoReader) {
        super(repoReader);
    }
