...
public class OverridingPolicyStrategy extends PolicyStrategy {

    private static final Logger logger =
            LoggerFactory.getLogger(OverridingPolicyStrategy.class);

    public static enum Strategy { FILENAME, ID }

    private Strategy m_override = Strategy.ID;

    public OverridingPolicyStrategy(RepositoryReader repoReader) {
        super(repoReader);
    }
